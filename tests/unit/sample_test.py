from adb_dbx_demo.tasks.sample_etl_task import SampleETLTask
from adb_dbx_demo.tasks.sample_ml_task import SampleMLTask
...
def test_jobs(spark: SparkSession, tmp_path: Path):
    ...
    test_ml_config = {
        "input": common_config,
        "experiment": "/Shared/adb-dbx-demo/sample_experiment"
    }
